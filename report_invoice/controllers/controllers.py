...
#             'objects': http.request.env['report_invoice.report_invoice'].search([]),
#         })

#     @http.route('/report_invoice/report_invoice/objects/<model("report_invoice.report_invoice"):obj>/', auth='public')
